...
uint8 SmartIO_1_initVar = 0u;

/* Clock configuration */
static uint32 SmartIO_1_clkConfig = 0u;
...
*
* \funcusage
*  \snippet SmartIO_1_SUT.c usage_SmartIO_1_Init
*******************************************************************************/
void SmartIO_1_Init(void)
{
    ...
    SmartIO_1_clkConfig = SmartIO_1_INIT_CLOCK_SRC;
    /* General control */
    SmartIO_1_CTL = SmartIO_1_INIT_CTL_CONFIG;
    /* Synchronization control */
    SmartIO_1_SYNC_CTL = SmartIO_1_INIT_SYNC_CONFIG;
    /* LUT input selection */
    SmartIO_1_LUT_CONGIG_BASE.lutSel[SmartIO_1_LUT0] = SmartIO_1_INIT_LUT0_SEL_CONFIG;
    SmartIO_1_LUT_CONGIG_BASE.lutSel[SmartIO_1_LUT1] = SmartIO_1_INIT_LUT1_SEL_CONFIG;
    SmartIO_1_LUT_CONGIG_BASE.lutSel[SmartIO_1_LUT2] = SmartIO_1_INIT_LUT2_SEL_CONFIG;
    SmartIO_1_LUT_CONGIG_BASE.lutSel[SmartIO_1_LUT3] = SmartIO_1_INIT_LUT3_SEL_CONFIG;
    SmartIO_1_LUT_CONGIG_BASE.lutSel[SmartIO_1_LUT4] = SmartIO_1_INIT_LUT4_SEL_CONFIG;
    SmartIO_1_LUT_CONGIG_BASE.lutSel[SmartIO_1_LUT5] = SmartIO_1_INIT_LUT5_SEL_CONFIG;
    SmartIO_1_LUT_CONGIG_BASE.lutSel[SmartIO_1_LUT6] = SmartIO_1_INIT_LUT6_SEL_CONFIG;
    SmartIO_1_LUT_CONGIG_BASE.lutSel[SmartIO_1_LUT7] = SmartIO_1_INIT_LUT7_SEL_CONFIG;
    /* LUT control */
    SmartIO_1_LUT_CONGIG_BASE.lutCtl[SmartIO_1_LUT0] = SmartIO_1_INIT_LUT0_CTL_CONFIG;
    SmartIO_1_LUT_CONGIG_BASE.lutCtl[SmartIO_1_LUT1] = SmartIO_1_INIT_LUT1_CTL_CONFIG;
    SmartIO_1_LUT_CONGIG_BASE.lutCtl[SmartIO_1_LUT2] = SmartIO_1_INIT_LUT2_CTL_CONFIG;
    SmartIO_1_LUT_CONGIG_BASE.lutCtl[SmartIO_1_LUT3] = SmartIO_1_INIT_LUT3_CTL_CONFIG;
    SmartIO_1_LUT_CONGIG_BASE.lutCtl[SmartIO_1_LUT4] = SmartIO_1_INIT_LUT4_CTL_CONFIG;
    SmartIO_1_LUT_CONGIG_BASE.lutCtl[SmartIO_1_LUT5] = SmartIO_1_INIT_LUT5_CTL_CONFIG;
    SmartIO_1_LUT_CONGIG_BASE.lutCtl[SmartIO_1_LUT6] = SmartIO_1_INIT_LUT6_CTL_CONFIG;
    SmartIO_1_LUT_CONGIG_BASE.lutCtl[SmartIO_1_LUT7] = SmartIO_1_INIT_LUT7_CTL_CONFIG;
    /* Turn off the DU */
    SmartIO_1_DU_SEL = SmartIO_1_INIT_DU_SEL;
    SmartIO_1_DU_CTL = SmartIO_1_INIT_DU_CTL;
    SmartIO_1_DATA = SmartIO_1_INIT_DU_DATA_REG;
}


/*******************************************************************************
* Function Name: SmartIO_1_Start
****************************************************************************//**
*
* \brief Invokes SmartIO_1_Init() and SmartIO_1_Enable().
*  
* After this function call, the component is initialized to specified values
* in the Configuration dialog and is then enabled.
*
* If calling this function after calling SmartIO_1_Stop(), the fabric
* will set the clock configuration as specified before calling Stop().
*
* \globalvars
*  SmartIO_1_initVar - used to check initial configuration, modified
*  on first function call.
*
* \funcusage
*  \snippet SmartIO_1_SUT.c usage_SmartIO_1_Start
*******************************************************************************/
void SmartIO_1_Start(void)
{
    uint32 regVal;
    
    if (0u == SmartIO_1_initVar)
    {
        SmartIO_1_Init();
        SmartIO_1_initVar = 1u; /* Component was initialized */
    }
    else
    {
        /* Restore the component settings if Stop() was called */
        if ((SmartIO_1_CTL & SmartIO_1_FABRIC_MASK) == 0u)
        {
            /* Clear the pipeline bit and clear the clock field */            
            regVal = SmartIO_1_CTL & SmartIO_1_PIPELINE_DISABLE & SmartIO_1_CLOCK_CLEAR;
            /* Restore the clock settings */
            SmartIO_1_CTL = regVal | SmartIO_1_clkConfig;
        }
    }
    SmartIO_1_Enable();
}
...
* 
* \globalvars
*  SmartIO_1_clkConfig - used to save the clock configuration.
*
* \funcusage
*  \snippet SmartIO_1_SUT.c usage_SmartIO_1_Stop
*******************************************************************************/
void SmartIO_1_Stop(void)
{
    ...
    SmartIO_1_clkConfig = SmartIO_1_CTL & SmartIO_1_CLOCK_MASK;
    /* Clear the clock source */
    regVal = SmartIO_1_CTL & SmartIO_1_CLOCK_CLEAR;
    /* Enable the pipeline and set the clock source to const zero */
    SmartIO_1_CTL = regVal | SmartIO_1_PIPELINE_ENABLE | SmartIO_1_CLOCK_CONST_ZERO;
}


/*******************************************************************************
* Function Name: SmartIO_1_SetBypass
****************************************************************************//**
*
...
*
* \funcusage
*  \snippet SmartIO_1_SUT.c usage_SmartIO_1_SetBypass
*******************************************************************************/
...
{   
    ...
    regVal = SmartIO_1_CTL & SmartIO_1_BYPASS_CLEAR;
    SmartIO_1_CTL = regVal | (((uint32)(portChannel << CYFLD_PRGIO_PRT_BYPASS__OFFSET))
                                    & SmartIO_1_BYPASS_MASK);
    /* Re-enable the block */
    SmartIO_1_Enable();
}
...
/*******************************************************************************
* Function Name: SmartIO_1_ClockSelect
****************************************************************************//**
*
...
*
* \funcusage
*  \snippet SmartIO_1_SUT.c usage_SmartIO_1_ClockSelect
*******************************************************************************/
void SmartIO_1_ClockSelect(uint32 clockSrc)
{
    ...
    regVal = SmartIO_1_CTL & SmartIO_1_CLOCK_CLEAR;
    SmartIO_1_CTL = regVal | (((uint32)(clockSrc << CYFLD_PRGIO_PRT_CLOCK_SRC__OFFSET) 
                                    & SmartIO_1_CLOCK_MASK));
    /* Re-enable the block */
    SmartIO_1_Enable();
}
...
/*******************************************************************************
* Function Name: SmartIO_1_HoldOverride
****************************************************************************//**
*
...
*
* \funcusage
*  \snippet SmartIO_1_SUT.c usage_SmartIO_1_HoldOverride
*******************************************************************************/
void SmartIO_1_HoldOverride(uint32 ovCtrl)
{
    ...
    if (ovCtrl == SmartIO_1_OVCTRL_ENABLE)
    {
        SmartIO_1_CTL |= SmartIO_1_HLD_OVR_SMARTIO;
    }    
    else
    {
        SmartIO_1_CTL &= SmartIO_1_HLD_OVR_HSIOM;
    }
    /* Re-enable the block */
    SmartIO_1_Enable();
}
...
/*******************************************************************************
* Function Name: SmartIO_1_IoSyncMode
****************************************************************************//**
*
...
*
* \funcusage
*  \snippet SmartIO_1_SUT.c usage_SmartIO_1_IoSyncMode
*******************************************************************************/
void SmartIO_1_IoSyncMode(uint32 portTerm)
{
    ...
    regVal = SmartIO_1_SYNC_CTL & SmartIO_1_IO_SYNC_CLEAR;
    SmartIO_1_SYNC_CTL = regVal | (((uint32)(portTerm << CYFLD_PRGIO_PRT_IO_SYNC_EN__OFFSET))
                                         & SmartIO_1_IO_SYNC_MASK);
    /* Re-enable the block */
    SmartIO_1_Enable();
}
...
/*******************************************************************************
* Function Name: SmartIO_1_ChipSyncMode
****************************************************************************//**
*
...
*
* \funcusage
*  \snippet SmartIO_1_SUT.c usage_SmartIO_1_ChipSyncMode
*******************************************************************************/
void SmartIO_1_ChipSyncMode(uint32 portTerm)
{
    ...
    regVal = SmartIO_1_SYNC_CTL & SmartIO_1_DATA_SYNC_CLEAR;
    SmartIO_1_SYNC_CTL = regVal | (((uint32)(portTerm << CYFLD_PRGIO_PRT_CHIP_SYNC_EN__OFFSET))
                                        & SmartIO_1_DATA_SYNC_MASK);
    /* Re-enable the block */
    SmartIO_1_Enable();
}
...
/*******************************************************************************
* Function Name: SmartIO_1_LUT_SelectInputs
****************************************************************************//**
*
...
*
* \funcusage
*  \snippet SmartIO_1_SUT.c usage_SmartIO_1_LUT_SelectInputs
*******************************************************************************/
cystatus SmartIO_1_LUT_SelectInputs(uint32 lutNum, uint32 inputNum, uint32 inputSrc)
{
    ...
    /* Input validation */
    if((inputSrc == SmartIO_1_SRC_LUT0) && ((inputNum & SmartIO_1_LUT_INPUT0) == SmartIO_1_LUT_INPUT0))
    {
        /* LUT input0 does not support LUT0 as an input */
        callStatus = CYRET_BAD_PARAM;
    }
    if((inputSrc == SmartIO_1_SRC_DU) && ((inputNum & (SmartIO_1_LUT_INPUT1 | SmartIO_1_LUT_INPUT2)) != 0u))
    {
    ...
    if (callStatus != CYRET_BAD_PARAM)
    {
        ...
        sel = SmartIO_1_LUT_CONGIG_BASE.lutSel[lutNum];
        switch(inputNum)
        {
            case SmartIO_1_LUT_INPUT0:
                sel = (sel & SmartIO_1_LUT_TR0_CLEAR) 
                        | ((uint32)(inputSrc << CYFLD_PRGIO_PRT_LUT_TR0_SEL__OFFSET) & SmartIO_1_LUT_TR0_MASK);
                break;
            case SmartIO_1_LUT_INPUT1:
                sel = (sel & SmartIO_1_LUT_TR1_CLEAR) 
                        | ((uint32)(inputSrc << CYFLD_PRGIO_PRT_LUT_TR1_SEL__OFFSET) & SmartIO_1_LUT_TR1_MASK);
                break;
            case SmartIO_1_LUT_INPUT2:
                sel = (sel & SmartIO_1_LUT_TR2_CLEAR)
                        | ((uint32)(inputSrc << CYFLD_PRGIO_PRT_LUT_TR2_SEL__OFFSET) & SmartIO_1_LUT_TR2_MASK);
                break;
            case SmartIO_1_LUT_INPUT_ALL:
                sel = (sel & SmartIO_1_LUT_TR_CLEAR_ALL) 
                        | ((uint32)(inputSrc << CYFLD_PRGIO_PRT_LUT_TR0_SEL__OFFSET) & SmartIO_1_LUT_TR0_MASK)
                        | ((uint32)(inputSrc << CYFLD_PRGIO_PRT_LUT_TR1_SEL__OFFSET) & SmartIO_1_LUT_TR1_MASK)
                        | ((uint32)(inputSrc << CYFLD_PRGIO_PRT_LUT_TR2_SEL__OFFSET) & SmartIO_1_LUT_TR2_MASK);
                break;
        ...
        SmartIO_1_LUT_CONGIG_BASE.lutSel[lutNum] = sel;
...
/*******************************************************************************
* Function Name: SmartIO_1_LUT_ConfigureMode
****************************************************************************//**
*
...
*
* \funcusage
*  \snippet SmartIO_1_SUT.c usage_SmartIO_1_LUT_ConfigureMode
*******************************************************************************/
void SmartIO_1_LUT_ConfigureMode(uint32 lutNum, uint32 mapping, uint32 mode)
{
    ...
    ctl = SmartIO_1_LUT_CONGIG_BASE.lutCtl[lutNum] & SmartIO_1_LUT_CTL_CLEAR;
    SmartIO_1_LUT_CONGIG_BASE.lutCtl[lutNum] = ctl 
                                            | (((uint32)((mapping << CYFLD_PRGIO_PRT_LUT__OFFSET)
                                            & SmartIO_1_LUT_MAP_MASK))
                                            | ((uint32)(((uint32)mode << CYFLD_PRGIO_PRT_LUT_OPC__OFFSET) 
                                            & SmartIO_1_LUT_OPC_MASK)));
    /* Re-enable the block */
    SmartIO_1_Enable();
}

/*******************************************************************************
* Function Name: SmartIO_1_DU_SelectTriggers
****************************************************************************//**
*
...
*
* \funcusage
*  \snippet SmartIO_1_SUT.c usage_SmartIO_1_DU_SelectTriggers
*******************************************************************************/
cystatus SmartIO_1_DU_SelectTriggers(uint32 tr0Sel, uint32 tr1Sel, uint32 tr2Sel)
{
    ...
    if((tr0Sel > SmartIO_1_DUTRIG_MAX) || (tr1Sel > SmartIO_1_DUTRIG_MAX) || (tr2Sel > SmartIO_1_DUTRIG_MAX))
    {
        callStatus = CYRET_BAD_PARAM;
    }
    else
    {
        ...
        sel = SmartIO_1_DU_SEL & SmartIO_1_DU_TR_CLEAR_ALL;
        SmartIO_1_DU_SEL = sel 
...
/*******************************************************************************
* Function Name: SmartIO_1_DU_SelectData
****************************************************************************//**
*
...
*
* \funcusage
*  \snippet SmartIO_1_SUT.c usage_SmartIO_1_DU_SelectData
*******************************************************************************/
cystatus SmartIO_1_DU_SelectData(uint32 dataNum, uint32 dataSel)
{
    ...
    sel = SmartIO_1_DU_SEL;
    switch(dataNum)
    {
        case SmartIO_1_DATA0:
            sel = (sel & SmartIO_1_DU_DATA0_CLEAR)
                  | (uint32)((dataSel << CYFLD_PRGIO_PRT_DU_DATA0_SEL__OFFSET) & SmartIO_1_DU_DATA0_MASK);
        break;
        case SmartIO_1_DATA1:
            sel = (sel & SmartIO_1_DU_DATA1_CLEAR)
                  | (uint32)((dataSel << CYFLD_PRGIO_PRT_DU_DATA1_SEL__OFFSET) & SmartIO_1_DU_DATA1_MASK);
        break;
        case SmartIO_1_DATA_BOTH:
            sel = (sel & SmartIO_1_DU_DATA01_CLEAR_BOTH)
                   |(uint32)((dataSel << CYFLD_PRGIO_PRT_DU_DATA0_SEL__OFFSET) & SmartIO_1_DU_DATA0_MASK)
                   |(uint32)((dataSel << CYFLD_PRGIO_PRT_DU_DATA1_SEL__OFFSET) & SmartIO_1_DU_DATA1_MASK);
        break;
        default:
...
/*******************************************************************************
* Function Name: SmartIO_1_DU_RegValue
****************************************************************************//**
*
...
*
* \funcusage
*  \snippet SmartIO_1_SUT.c usage_SmartIO_1_DU_RegValue
*******************************************************************************/
cystatus SmartIO_1_DU_RegValue(uint32 dataValue)
{
    cystatus callStatus = CYRET_SUCCESS;
    
    if(dataValue > SmartIO_1_REGVAL_MAX)
    {
        callStatus = CYRET_BAD_PARAM;
    }
    else
...
/*******************************************************************************
* Function Name: SmartIO_1_DU_OpCode
****************************************************************************//**
*
...
*
* \funcusage
*  \snippet SmartIO_1_SUT.c usage_SmartIO_1_DU_OpCode
*******************************************************************************/
cystatus SmartIO_1_DU_OpCode(uint32 opCode, uint32 dataSize)
{
    cystatus callStatus = CYRET_SUCCESS;
    
    if((opCode == 0u) || (opCode > SmartIO_1_OPC_MAX) || (dataSize > SmartIO_1_DUSIZE_MAX))
    {
        callStatus = CYRET_BAD_PARAM;
    }
    else
    {
         /* Must disable the block before configuring */
        SmartIO_1_Disable();
        SmartIO_1_DU_CTL = (uint32)(((dataSize - 1u) << CYFLD_PRGIO_PRT_DU_SIZE__OFFSET))
